...
from pinterestcom_project.parser_app.modules.trash.auth import pinterest_login
    ...
    with sync_playwright() as p:
        for profile in ads_profiles:
            ...
            try:
                ...
                if email is None:
                    print(f"❌ No Pinterest account found for profile {profile_id}. Skipping this profile.")
                    if browser:
                        browser.close()
                    continue
